...
export default function AdminProfile() {
  ...
  return (
    ...
    <div className='user-profile'>
      <h1 className='user-profile-name'>Admin Profile</h1>
      ...
      <div className='flex justify-between mt-5'>
        ...
        <Link className='navigate-button-additem' to='/additem'><li>Add Garbage</li></Link> 
        <Link className='my-items-button' to='/items'><li>My Garbage Details</li></Link> 
